...
Серверное приложение для интернет-магазина, обеспечивающее управление товарами, заказами и пользователями. Реализовано на .NET 10 с использованием чистой архитектуры и принципов Domain-Driven Design.
...
- CRUD операции с товарами (требует прав администратора)
...
- **sgc433** — разработчик, проектирование архитектуры, реализация бизнес-логики
